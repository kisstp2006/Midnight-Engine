  ...
  // SolidBoxes
  {
    ...
    if (uiNumSolidBoxes != 0)
    {
      ...
      while (uiNumSolidBoxes > 0)
      {
        ...
        pGALCommandEncoder->UpdateBuffer(hBuffer, 0, ezMakeArrayPtr(pSolidBoxData, uiNumSolidBoxesInBatch).ToByteArray(), ezGALUpdateMode::NoOverwrite);
  ...
  // Triangles
  {
    ...
    if (uiNumTriangleVertices != 0)
    {
      ...
      while (uiNumTriangleVertices > 0)
      {
        ...
        pGALCommandEncoder->UpdateBuffer(hBuffer, 0, ezMakeArrayPtr(pTriangleData, uiNumTriangleVerticesInBatch).ToByteArray(), ezGALUpdateMode::NoOverwrite);
    ...
    for (auto itTex = pData->m_texTriangle3DVertices.GetIterator(); itTex.IsValid(); ++itTex)
    {
      ...
      if (uiNumVertices != 0)
      {
        ...
        while (uiNumVertices > 0)
        {
          ...
          pGALCommandEncoder->UpdateBuffer(hBuffer, 0, ezMakeArrayPtr(pTriangleData, uiNumVerticesInBatch).ToByteArray(), ezGALUpdateMode::NoOverwrite);
  ...
  // 3D Lines
  {
    ...
    if (uiNumLineVertices != 0)
    {
      ...
      while (uiNumLineVertices > 0)
      {
        ...
        pGALCommandEncoder->UpdateBuffer(hBuffer, 0, ezMakeArrayPtr(pLineData, uiNumLineVerticesInBatch).ToByteArray(), ezGALUpdateMode::NoOverwrite);
  ...
  // LineBoxes
  {
    ...
    if (uiNumLineBoxes != 0)
    {
      ...
      while (uiNumLineBoxes > 0)
      {
        ...
        renderViewContext.m_pRenderContext->BindBuffer("boxData", pDevice->GetDefaultResourceView(hBuffer));
        pGALCommandEncoder->UpdateBuffer(hBuffer, 0, ezMakeArrayPtr(pLineBoxData, uiNumLineBoxesInBatch).ToByteArray(), ezGALUpdateMode::NoOverwrite);
  ...
  // Text
  {
    ...
    if (uiNumGlyphs != 0)
    {
      ...
      while (uiNumGlyphs > 0)
      {
        ...
        pGALCommandEncoder->UpdateBuffer(hBuffer, 0, ezMakeArrayPtr(pGlyphData, uiNumGlyphsInBatch).ToByteArray(), ezGALUpdateMode::NoOverwrite);
  ...
  // 2D Rectangles
  {
    ...
    if (uiNum2DVertices != 0)
    {
      ...
      while (uiNum2DVertices > 0)
      {
        ...
        pGALCommandEncoder->UpdateBuffer(hBuffer, 0, ezMakeArrayPtr(pTriangleData, uiNum2DVerticesInBatch).ToByteArray(), ezGALUpdateMode::NoOverwrite);
